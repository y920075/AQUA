...
class Area extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.Regions !== prevProps.Regions) {
            ...
            this.setState ({Eastcoastlist : localRegions.filter(area=>area.LocationArea=="花東海岸")})
            this.setState({Northeastcapelist : localRegions.filter(area=>area.LocationArea=="東北角")})
            this.setState({Greenislandlist : localRegions.filter(area=>area.LocationArea=="綠島")})
            this.setState({Iralalist : localRegions.filter(area=>area.LocationArea=="蘭嶼")})
            this.setState({Kentinglist  : localRegions.filter(area=>area.LocationArea=="墾丁")})
                    ...
                    <Card className="locationcard">
                        ...
                        <Card.Body>
                            <ul className="locationlist">
                                ...
                                return (
                                    <li key={index}>
                                        <Link role="button" to={value.LocationID}>{value.LocationName}</Link>
                                    </li>
                                )
                            })}
                            </ul>
