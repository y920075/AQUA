...
//顯示資料的動作函數
import { sellerEditAsync } from '../../../../actions/seller'

//更新資料的動作函數

import { sellerUpdateAsync } from '../../../../actions/seller'
...
function SellerEdit(props) {
    ...
    const handleSubmit = () => {
      ...
      const userData = { name, email, username, password, sellerName,mobile,phone,description,infofile,shopfile }
    ...
    return (
        ...
        <div className="form-group">
          ...
          <div className="form-group">
            ...
            <div>
            <textarea id="w3mission" rows="4" cols="50" onChange={e => setDescription(e.target.value)}></textarea>
            </div>
            </div>
            <div className="form-group">
...
const mapStateToProps = store => {
  ...
  export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SellerEdit))
