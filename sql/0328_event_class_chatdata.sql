...
INSERT INTO `chat_data` (`id`, `roomId`, `memberId`, `message`, `created_at`) VALUES
(1, 'E20030001', 'M20010002', '安安你好', '2020-03-28 11:09:26'),
(2, 'E20030001', 'M20010001', '安安你好安安你好安安你好', '2020-03-28 12:09:26'),
(3, 'E20030001', 'M20010001', 'E20040001', '2020-03-28 12:15:47'),
(19, 'E20030001', 'M20010002', '123', '2020-03-28 14:02:31'),
(36, 'E20030001', 'M20010002', '哈囉~', '2020-03-28 15:26:30'),
(37, 'E20030001', 'M20010002', '我好嗎', '2020-03-28 15:26:35'),
(38, 'E20030001', 'M20010002', '你好嗎', '2020-03-28 15:26:41'),
(39, 'E20030001', 'M20010002', '真D酷炫', '2020-03-28 15:28:17'),
(64, 'E20030001', 'M20010002', '讚', '2020-03-28 19:35:01'),
(65, 'E20030001', 'M20010002', '時間測試', '2020-03-28 19:57:20'),
(66, 'E20030001', 'M20010002', '123', '2020-03-28 20:23:37');
...
(72, 1, 'E20030001', '極淨無塑-國際淨灘行動_台北場', 'Etype002', '淨灘活動', '新北市八里區', '新北市八里區挖仔尾海灘', '25.1664652', '121.4164369', 'M20010003', '2020-04-05 09:00:00', '2020-04-04 23:59:00', '不忍直視海洋生物的悲鳴？\n奮力抵抗塑膠微粒的滲透？\n體內的海潮，波濤洶湧，\n召喚你，重返碧海藍天的時光！\n\n行旅海岸，呼吸吐納；\n彎下身軀，親吻白沙；\n撿拾垃圾，純淨身心。\n\n還海灘極淨，讓視野無塑。\n原來，療癒海洋，便是療癒自己。\n \n\n我們誠摯地邀請您，跟全世界愛海的朋友一起加入2019國際淨灘的行列。今年度不只是淨灘，同時我們也安排海洋攤位，透過活動教案及展示，邀請各方朋友來認識海洋、關心海洋！而不在現場的民眾，也可以從自身做起，以重複使用的態度向用過就丟的習慣說再見。讓我們一起從生活中，慢慢地減少使用塑膠製品，從事更多愛海的行動。', 50, 1, 'E20200325162244.jpg', '2020-03-25 16:22:44', '2020-03-28 17:58:29'),
