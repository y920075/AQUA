...
import {customerGetAsync,customerUseAsync,customerMailDataAsync} from '../../../../actions/seller/index'
                ...
                <div className="col-lg-4">
                  ...
                  <div>
                      {customerdata.map((element,index)=>{
                       return  <div key={index} className="active-chin-td my-2 rounded">
                       <div onClick={
                         event =>{
...
const mapDispatchToProps = dispatch => {
  // postToBack
  // storeEmail(email)
  return bindActionCreators({ customerGetAsync,customerUseAsync,customerMailDataAsync }, dispatch)
}
