...
import {
  getuserDetailDataAsync,
  updateuserDetailDataAsync,
} from '../../actions/member/memberActions'
...
function UserContent(props) {
  ...
  const handleUpdate = async () => {
    ...
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/members/`,
      {
        method: 'POST',
        body: member_fd,
        credentials: 'include',
      ...
      <div className="card infocard-hs">
        ...
        <form>
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              defaultValue={userInfo ? userInfo[0].memberId : ''}
              type="text"
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              ...
              defaultValue={userInfo ? userInfo[0].fullName : ''}
              type="text"
              className="form-control"
              name="fullName"
            />
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              ...
              defaultValue={userInfo ? userInfo[0].mobileNumber : ''}
              type="text"
              className="form-control"
              name="mobileNumber"
            />
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              ...
              defaultValue={userInfo ? userInfo[0].email : ''}
              type="email"
              className="form-control"
              name="email"
            />
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              ...
              defaultValue={userInfo ? userInfo[0].address : ''}
              type="text"
              className="form-control"
              name="address"
            />
          ...
          <div className="input-hs md-form form-group mt-5 col-lg-12">
            ...
            <input
              defaultValue={userInfo ? userInfo[0].JoinDate : ''}
              type="text"
              className="form-control"
              disabled
            />
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators(
    { getuserDetailDataAsync, updateuserDetailDataAsync },
    dispatch
  )
}
