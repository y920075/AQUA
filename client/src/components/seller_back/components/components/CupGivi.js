...
function CupGivi(props) {
    ...
    <form name="form1 input-style-chin">
            ...
            <div className="row">
                ...
                <div className="col-lg-6 input-style-chin">
                <div className="form-group my-3 input-text-middle-chin">
                <select name="givi_name" className="custom-select" onChange={event =>setGivi(event.target.value)}>
                <option defaultValue="套用商品種類">套用商品種類</option>
                 { props.givi.coupon['table6']?( props.givi.coupon['table6'].map((item,index) => {
                      return <option key={index} value={item.givi_name}>{item.givi_name}</option>
                    ...
                    <div className="form-group my-3">
                       ...
                       <label htmlFor="exampleInputPassword1">設定贈品贈送數目:</label>
                           ...
                           <input 
                            ...
                            style={inputstyle} 
                            type="text" 
                            onChange = {(event)=>{setGiviPieceMode(event.target.value)}}
                            className="form-control"/>
                           <div className="input-group-append">
...
const mapStateToProps = store => {
  ...
  export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(CupGivi)
  )
