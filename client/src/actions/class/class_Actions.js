...
export const getTypeLevelDataAsync = () => {
  return async (dispatch) => {
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/classtype/level`,
      {
        method: 'GET',
        headers: new Headers({
...
export const getClassDataAsync = (type, level, sort, page, isEnable) => {
  return async (dispatch) => {
    ...
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/class?${query}`,
      {
        method: 'GET',
        headers: new Headers({
          Accept: 'application/json',
...
export const getclassDetailDataAsync = (classId) => {
  return async (dispatch) => {
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/class/${classId}`,
      {
        method: 'GET',
        headers: new Headers({
          Accept: 'application/json',
...
export const memberJoinClassAsync = (classId, memberMemo) => {
  return async (dispatch) => {
    ...
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/member/class/${classId}`,
      {
        method: 'POST',
        body: fd,
        credentials: 'include',
...
export const memberGetClassDataAsync = (sort, page, isEnable) => {
  return async (dispatch) => {
    ...
    const request = new Request(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/member/class?${query}`,
      {
        method: 'GET',
        credentials: 'include',
        headers: new Headers({
